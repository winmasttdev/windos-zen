...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self.lbl_logo.setPixmap(icon_windos(16).pixmap(16, 16))
        ...
        for i, (txt, ic) in enumerate([
            ("Welcome", icon_windos(14)),
            ("Disk", icon_disk(14)),
            ("User", icon_user(14)),
            ("Summary", icon_summary(14)),
            ("Install", icon_install(14)),
        ]):
            row = QHBoxLayout()
            row.setSpacing(10)
            step_ic = QLabel()
            step_ic.setPixmap(ic.pixmap(14, 14))
            step_ic.setFixedSize(16, 16)
            step_lbl = QLabel(txt)
